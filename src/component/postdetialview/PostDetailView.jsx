          ...
          <div className="col-12">
            {isLoading ? (
              <div className="custom-loader">
                  <img className="img-fluid-logoo" src={Loader} alt="loading" />
               </div>
            ) : (
              <div className="card">
                    ...
                    <div className="col-lg-4 col-md-4 col-sm-6 col-12">
                      <div className="gr-post-info-box  ">
                        ...
                        <div className="info-box-content">
                          ...
                          <h5 className="info-box-number">
                            {data !== undefined ? data.comments_count : 0}
                          </h5>
                        </div>
                      </div>
                    </div>
                      ...
                      <tr>
                        <th colSpan={2}>
                          {data.url !== undefined && (
                            <img
                              src={
                                data !== undefined ? data.url : postplaceholder
                              }
                              alt="img"
                            />
                          )}
